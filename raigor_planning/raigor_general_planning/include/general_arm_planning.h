// a pick ang place demo, initialized in 211124, last modified 221010
...
public:
    ...
    double arm_command_time_;
    double last_arm_command_time_;
    Eigen::Vector3f last_desired_ee_map_position_;
    int diff_index_;
};
